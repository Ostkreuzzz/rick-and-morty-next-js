  ...
  return (
    <div className="flex flex-col gap-56 px-16 desktop:px-32  w-fit">
      <div className="flex justify-center tablet:justify-start  text-white rounded-lg bg-blue ">
        <div className="flex flex-col tablet:flex-row gap-24 tablet:gap-48 p-32 justify-start">
          <div className="flex flex-col gap-32">
            <div className="flex flex-col tablet-large:flex-row justify-start gap-32">
              <Image
